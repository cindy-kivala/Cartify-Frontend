      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {products.map((product) => (
            <div
              key={product.id}
              className="product-card flex flex-col justify-between transform hover:-translate-y-1 transition-all duration-300"
            >
              ...
              <div className="mt-3 flex flex-col justify-between h-full">
                <Link to={`/products/${product.id}`} className="hover:text-accent-neon-blue transition">
                  <h2 className="product-name mb-2 line-clamp-2">{product.name}</h2>
                </Link>
